	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="index.html"><span class="fa fa-area-chart"></span> Welcome<span class="dashboard_text">Black Spot Detectio</span></a></h1>
          </div>
						 	 ...
						 	 <th>Zone</th>
						 	  <th>City</th> 
								...
								{   
									...
									ps1.setString(1, UserData.getCity());
